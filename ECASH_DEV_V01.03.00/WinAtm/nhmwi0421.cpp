...
BOOL CNHMWI::CoinGetIsInitialized()
{
	BOOL result;
	InvokeHelper(0x295, DISPATCH_METHOD, VT_BOOL, (void*)&result, NULL);
	return result;
}
...
CString CNHMWI::CIMGetLogicalUnit()
{
	CString result;
	InvokeHelper(0x2a7, DISPATCH_METHOD, VT_BSTR, (void*)&result, NULL);
	return result;
}
...
long CNHMWI::CIMCount()
{
	long result;
	InvokeHelper(0x2bc, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
	return result;
}
