#if !defined(AFX_NHMWI_H__03884972_1A58_48E8_B8B8_88EF622302F3__INCLUDED_)
#define AFX_NHMWI_H__03884972_1A58_48E8_B8B8_88EF622302F3__INCLUDED_
...
public:
	...
	CString CIMGetLogicalUnit(long nIndex);
	long CIMInitialize();
	...
	long IPMGetMediaInfo(long MediaID);
	long CIMWaitTaken();
	long IPMInitialize();
	...
	long CIMGetNumberOfItemType();
	CString PbmGetInkStatus();
	long CmrCaptureRoom(LPCTSTR lpszCamData);
	long CmrGetRoomCameraStatus();
	CString VfdGetDeviceType();
	long ScrSetDisplayDataW(LPCTSTR wszDataName, LPCTSTR wszDataValue);
	long SprPrintW(LPCTSTR szFormName, LPCTSTR szMediaName, LPCTSTR szPrintData);
	long IPMSetGuidLight(short LightIndex, long Command);
	long IPMGetAcceptorStatus();
	long IPMGetStackerStatus();
	long IPMGetNumOfBinCount();
	CString IPMGetBinCount();
	CString IPMGetBinStatus();
	long IPMGetMediaOnStacker();
	long IPMGetLastMediaInTotal();
	long IPMGetLastMediaAddedToStacker();
	long IPMGetTotalItems();
	long IPMGetTotalItemsRefused();
	CString IPMGetMediaImageStatus();
	CString IPMGetMediaImageFile();
	long IPMGetMediaNumOfImage();
	long IPMGetGuidLightsType(short GuidLightIndex);
	long IPMCountMoney();
	long CIMCountMoney();
	long IPMWaitTaken();
	long CIMClearDepositCount();
	long IPMClearDepositCount();
	long IPMGetInkStatus();
	long IPMGetTonerStatus();
	long BrmCancelRefill();
	long BrmCancelTakeup();
	long GroOpenShutter(long nWaitSec);
	long GroCloseShutter(long nWaitSec);
	long GroGetCSTStatus();
	long UcmOpenShutterAndTray(long nWaitSec);
	long GroOpenShutterAndTray(long nWaitSec);
	long SprEjectBoth(long nWaitSec);
	long McuEjectBoth(long nWaitSec);
	CString GetEventValue(long nDevID);
	long ICMMcuEntryDisable();
	CString ICMMcuGetCardData(long lDoNotUnPack);
	long ICMMcuInitialize();
	long ICMMcuRead();
	long ICMMcuRetract();
	long ICMMcuWrite(LPCTSTR szTrackData);
	long ICMMcuDeinitialize();
	long ICMMcuWaitTaken();
	long ICMMcuEntryEnable(long nWaitSec);
	long ICMMcuGetMaterialInfo();
	long ICMMcuEject(long nWaitSec);
	long ICMMcuEjectBoth(long nWaitSec);
	long ICMMcuGetDeviceStatus();
	long ICMMcuCancelWaitTaken();
	CString ICMMcuGetErrorCode();
	long ICMMcuClearErrorCode();
	CString ICMMcuGetSensorInfo();
	long ICMMcuClearRetractCnt();
	CString ICMMcuGetRetractCnt();
	CString ICMMcuGetICData();
	long ICMMcuICEntryEnable(long nWaitSec);
	long ICMMcuICEntryDisable();
	long ICMMcuICSendData(long ProtocolID, LPCTSTR szSendData, long nWaitSec);
	long ICMMcuICChipInitialize();
	void AboutBox();
};
...
#endif // !defined(AFX_NHMWI_H__03884972_1A58_48E8_B8B8_88EF622302F3__INCLUDED_)